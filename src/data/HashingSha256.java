...
public class HashingSha256 {
    ...
    /**
     * Возвращает хэш методом SHA256.
     *
     * @param message Сообщение в байтах.
     * @return Хэш сообщения в массив байтов.
     */
    ...
    /**
     * Заполняем существуюший массив длиной кратный
     * кратный 512 bits (64 byte), включайющий добавочный
     * 1-bit, k 0-bit, и сообщений длиной 64-bits.
     * Результат это 32 битный массиы интов с прямым порядком байтов
    ...
    /**
     * Преобразует массив int в массив байтов  ( int - 4 байта)
